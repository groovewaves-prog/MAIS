#!/bin/sh
#------------------------------------------------------------------------------
# MAIS syserror パトランプ鳴動用shell
# usage: Yellow_blink_patolamp.sh <arg1>
...
PATOLAMP_FILE="/var/lib/baogw/${1}_yellow_patolamp_on"

#---- start ----
LOGMSG="started '${1}' Yellow patolamp on"
putlog_i "START"
...
#---- end ----
LOGMSG="ended '${1}' Yellow patolamp on"
putlog_i "END"
exit 0
