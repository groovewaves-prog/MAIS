...
# 250130 Update by H.OOZERA 差分許容パラメータ以外を一致化
...
# --- BAOGW ip address ---
BAOGW01_IP = '10.136.160.160'
BAOGW02_IP = '10.136.163.160'
...
# --- zabbix api ---
ZABBIX_IP = 'localhost'
ZABBIX_USER = 'mais_sys_ope'
ZABBIX_PASSWD = 'K7r@mW9fPx2_vQu4H'
...
# patolamp pattern
#DN1500 http pattern
RED_PATOLAMP_PATTERN_DN1500 = '10010000'
YELLOW_PATOLAMP_PATTERN_DN1500 = '01010000'
GREEN_PATOLAMP_PATTERN_DN1500 = '00110000'

#DN1700 http pattern
RED_PATOLAMP_PATTERN_DN1700 = '20010000'
YELLOW_PATOLAMP_PATTERN_DN1700 = '02010000'
GREEN_PATOLAMP_PATTERN_DN1700 = '00210000'

# --- patolamp control parameters for floor-11th ---
FLOOR_11TH = 'floor_11th'
FLOOR_11TH_FILE = ''
FLOOR_11TH_PATLAMP_IP = '10.128.1.10'
FLOOR_11TH_PATLAMP_VER = 'DN1700'

# --- patolamp control parameters for floor-12th ---
FLOOR_12TH_HOSTGROUP = '新宿12階パトランプ';
FLOOR_12TH = 'floor_12th'
FLOOR_12TH_FILE = '_floor_12th'
FLOOR_12TH_PATLAMP_IP = '10.128.1.36'
FLOOR_12TH_PATLAMP_VER = 'DN1700'
...
KDDI_MIYAZAKI_FILE = '_howcom'
KDDI_MIYAZAKI_PATLAMP_IP = '10.136.173.190'
KDDI_MIYAZAKI_PATLAMP_VER = 'DN1500'

# --- patolamp control parameters for vip ---
VIP_HOSTGROUP = 'VIP顧客';
VIP = 'vip'
VIP_FILE = '_vip'
VIP_PATLAMP_IP = FLOOR_11TH_PATLAMP_IP
VIP_PATLAMP_VER = 'DN1700'
...
# --- BAO TM ip address ----
WEB_API_BASE_URL = "http://%s/baocdp/orca"
KISYS_TM_SECONDARY_SERVER_IP_ADDRESS = 'kistm4vtmbaovip1:38080'
KISYS_TM_PRIMARY_SERVER_IP_ADDRESS = 'kistm4vtmbaovip1:38080'
...
KOMPIRA_TOKEN = "48f329b86043cef41ffdac92dd49cc696aeda5a3"
...
# リトライ時の待機時間　　　
PATO_REQUEST_RETRY_INTERVAL = 1 # 秒

# タイムアウト時間
PATO_REQUEST_TIMEOUT= 2 # 秒

# --- フラグファイルディレクトリ ---
FLAG_DIR = '/var/lib/baogw'

# --- CSVファイルディレクトリ ---
PATOLAMP_CSV_FILE = '/usr/lib/zabbix/alertscripts/patolamp_param.csv'

# --- デフォルトパトランプグループ ---
DEFAULT_PATOLAMP_HOSTGROUP = 'ITOS'
