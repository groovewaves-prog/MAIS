...
class GwRescueIncidentsController extends AppController{
...
// ======================================================================================================================================================
    public function index() {
        ...
        $query_gwEvents = $this->GwEvents->find('all');
        $query_gwEvents->where(['GwEvents.event_status' => '0']);
        $query_gwEvents->where(['GwEvents.gw_incident_id is null']);
